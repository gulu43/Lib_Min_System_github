 ...
 * @author gulam
 */
public class See_All_Borrowed_books extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("All Current Borrowed Books");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "book name", "days remaning", "late amount"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(See_All_Borrowed_books.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new See_All_Borrowed_books().setVisible(true);
            }
        });
    }
